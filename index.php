...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero" style="background-image: url('https://img.freepik.com/free-vector/clean-medical-background_53876-97927.jpg?w=2000');">
    <div class="main-div d-flex align-items-center justify-content-center">
        <div class="s-div">
          <div class="m-2 h-40">
            <h2 class="text-center">e-Health Registration</h2>
          </div>
          <div class="h-20 mt-5 mb-4">
            <p class="text-center">During Registration you need one of these</p>
          </div>
          <div class="d-flex justify-content-center align-items-center h-20">
            <div class="mr-4 pr-5"><i class="fa fa-id-card fa-2x"></i></div>
            <div class="mr-5 pr-5"><i class="fa fa-id-card fa-2x"></i></div>
            <div class=""><i class="fa fa-book fa-2x"></i></div>
          </div>
          <div class="d-flex justify-content-center align-items-center h-20 ml-4">
            <div class="mr-4 pl-2">NID</div>
            <div class="mr-4 pl-3">Birth Certificate</div>
            <div class="m-2 pl-2">Passport</div>
          </div>
        </div>
      </div>
    </div>
