      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
         ...
         <div class="col-lg-6 col-md-6 col-sm-12 mt-5" >
            ...
            <form class="border border-rounded  mb-5 text-black p-5" action="add_recordAction.php" method="post" enctype="multipart/form-data" >
                  <div class="mb-4 text-center">
                     <h3>Add New Record</h3>
                  </div>
                   <div class="mb-2 ">
                     <!-- Username: -->
                     <label for="nid">Hospital Name/Clinic Name</label>
                     <input type="text" class="form-control "  name="h_name" placeholder="Enter hospital or clinic name"  required>
                   </div>
                   <div class="mb-2 ">
                    <!-- Username: -->
                    <label for="dob">Dr. Name</label>
                    <input type="text" class="form-control "  name="d_name" placeholder="Enter Dr. name" required>
                  </div>
                  <div class="mb-2 ">
                    <!-- Username: -->
                    <label for="dob">Prescriptions</label>
                    <input type="file" class="form-control "  name="prescription" placeholder="Add prscription"  required>
                    <span class=""><p>You can add only one prescription in a single record.</p></span>
                  </div>
                  <div class="mb-4 ">
                    <!-- Username: -->
                    <label for="dob">Reports</label>
                    <input type="file" class="form-control "  name="reports[]" placeholder="Add reporst" multiple >
                  </div>
                  <!-- <div class="mb-2 ">
                    
                    <label for="dob">Dr. Name</label>
                    <input type="text" class="form-control "  name="l_pass" placeholder="Enter Your Password" required>
                  </div>
                  <div class="mb-2 ">
                   ...
                   <button type="submit" class="btn pt-2 btn-primary btn-block btn-info rounded" name="sub">Add</button>
     
                   <!-- <p class="forgot pt-3">Are you New? <a href="login.html">Register Here</a></p>   -->
