<?php
                ...
                $recordCheck = mysqli_query($conn,"SELECT * FROM `c_information` WHERE nid = '$nid' ");
               

                // $match = mysqli_query($conn, $recordCheck);
                $data = mysqli_fetch_array($recordCheck);

                $imageData= mysqli_query($conn,"SELECT * FROM `health_info` WHERE nid = '$nid' ");
  ...
  <div class="row align-items-center position-relative">
    ...
    <div class="col-12">
      ...
      <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
          ...
          <li><a href="profile.php" class="nav-link"><?php echo $nid; ?></a></li>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-12"><label class="labels">Date of Birth</label><input type="text" class="form-control" name="u_dob" placeholder="" value="<?php echo $data['dob']?>"readonly></div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">E-mail</label><input type="text" class="form-control" name="u_email" placeholder="enter email address" value="<?php echo $row['email']?>"></div>
                    <div class="col-md-12"><label class="labels">Phone</label><input type="text" class="form-control" name="u_phone" placeholder="enter phone number" value="<?php echo $row['phone']?>"></div>
                    <div class="col-md-12"><label class="labels">Password</label><input type="password" class="form-control" name="u_pass" placeholder="Set Password" value="<?php echo $row['password']?>"></div>
